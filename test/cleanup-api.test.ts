...
async function createCaseWithIntake(base: string, jurisdiction: "US" | "EU" | "UK", riskLevel: "standard" | "high-risk-safety") {
...
async function runUntilApproval(base: string, caseId: string) {
