...
export default function DocPageFooter({ path, sourcePath }: DocPageFooterProps) {
  ...
  return (
    <footer className="doc-page-footer mt-10 pt-5 border-t" style={{ borderColor: 'var(--border-unified)' }}>
      <div
      ...
      >
        <div>
          ...
          <p className="text-xs" style={{ color: 'var(--muted-color)', fontFamily: 'var(--mono-font)' }}>
            {githubSourcePath}
          </p>
        </div>
